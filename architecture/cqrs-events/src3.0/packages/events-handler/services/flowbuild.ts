...
export function FlowbuidClient (){
    ...
    async function _createProcess(workflowName:string, result:any): Promise<any>{
    ...
    return {
        ...
        async createProcess(workflowName:string, result?:any){
            return _createProcess(workflowName, result ? result : {});
        }
    }
