...
def order_crossover(parent1, parent2):
    ...
    # Sempre pegarem um trecho do Gene do individuo, cortamos um pedaço e invertemos.
    # Assim criamos uma copia do trecho do Gene do individuo, e depois preenchemos com os genes que faltam.
    # Gerando assim um filho novo 
